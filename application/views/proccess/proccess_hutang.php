<?php
	...
	if(!empty(trim($_POST['uraian'])) and !empty(trim($_POST['tanggal']))){
		...
		if(isset($_POST['edit'])){
			...
			$sel2 = database()->Query("SELECT * FROM db_jurnalumum WHERE no_akun='11' and rec_module='21' and rec_group='".$sel1['rec_group']."' ")->Fetch();
			...
			WHERE id = '".$_POST['id']."' and rec_group = '".$sel1['rec_group']."' and rec_module='21' and no_akun !='11' and no_akun!='21' ")
				...
				WHERE id != '".$_POST['id']."' and rec_group = '".$sel1['rec_group']."' and rec_module='21' and no_akun='11' ")
			   and 
				...
				no_akun='21',
				debet='0',
				kredit='".($debet1 - $kredit2)."'

				WHERE id != '".$_POST['id']."' and rec_group = '".$sel1['rec_group']."' and rec_module='21' and no_akun='21' " )){
				echo hutang();
				echo "<success/>";
